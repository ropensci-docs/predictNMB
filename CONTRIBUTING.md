...
If you would like to see a change in predictNMB but the description
below on how to do so doesn’t help, create an issue or contact me (email
in DESCRIPTION).
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/predictNMB", fork = TRUE)`.
